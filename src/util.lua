Bakery_API.guard(function()
	...
	function ease_dollars(mod, instant)
		...
		if
			mod == nil
			or Bakery_API.big(mod) <= Bakery_API.big(0)
			or (
				not Bakery_API.no_money_decks[G.GAME.selected_back_key.key or G.GAME.selected_back_key]
				and not Bakery_API.no_money_decks[G.GAME.selected_sleeve]
			)
		then
