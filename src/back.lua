...
Bakery_API.guard(function()
    ...
    Bakery_API.econ_only_items = {
        'j_delayed_grat', 'j_business', 'j_faceless', 'j_cloud_9', 'j_rocket', 'j_reserved_parking', 'j_mail', 'j_to_the_moon', 'j_golden', 'j_ticket', 'j_rough_gem', 'j_satellite', 'j_todo_list',
        'j_Bakery_Auctioneer',
        'v_seed_money', 'v_money_tree',
        'c_hermit', 'c_temperance',
        'tag_skip', 'tag_economy', 'tag_garbage', 'tag_handy', 'tag_Bakery_TopTag', 'tag_Bakery_BottomTag',
        'BakeryCharm_Bakery_Coin', 'BakeryCharm_Bakery_Obsession' }
end)
-- END_KEEP_LITE
